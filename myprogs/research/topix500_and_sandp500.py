...
sandp500_weights = np.ones_like(sandp500_value_df["rt"]) / len(sandp500_value_df)
plt.hist(sandp500_value_df["rt"], bins = [(-0.5 + (i / 25.0)) for i in range(26)], weights=sandp500_weights, alpha = 0.5, ec = "black", label="S&P500")
# plt.hist(sandp500_value_df["rt"], bins = [(-0.5 + (i / 25.0)) for i in range(26)], alpha = 0.5, ec = "black", label="S&P500")
plt.grid(True)
...
plt.plot(sandp500_balance["rt"], label="S&P500")
plt.grid(True)
plt.title(graph_title)
plt.xlabel("date")
